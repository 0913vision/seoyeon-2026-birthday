...
const assets = [
    {
        name: 'part_24_chip',
        prompt:
            'Cute cartoon 3D small green circuit board CPU semiconductor chip, '
            + 'square green PCB with visible gold traces and tiny components, '
            + 'small silver metal pins around the edges, '
            + 'looks like a miniature computer chip or microprocessor, '
    ...
    },
    {
        name: 'part_19_ribbon',
        prompt:
            'Cute cartoon 3D pink satin ribbon tied in a beautiful bow knot, '
            + 'soft pink ribbon with golden edges, elegant simple bow shape, '
            + 'no flowers, no gems, just a pure ribbon bow, '
            + 'single isolated item, centered, '
            + BASE
            + ', transparent background',
    },
];
