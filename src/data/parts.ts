...
export const PARTS: PartDef[] = [
    ...
    { id: 20, name: '볼트', cost: [{ res: 'metal', amount: 350 }, { res: 'gem', amount: 250 }, { res: 'stone', amount: 400 }], craftTime: 45, workshop: 'jewelshop', day: 5 },
    { id: 21, name: '반도체', cost: [{ res: 'metal', amount: 400 }, { res: 'gem', amount: 250 }, { res: 'stone', amount: 1200 }, { res: 'wood', amount: 800 }], craftTime: 50, workshop: 'jewelshop', day: 5 },
    { id: 22, name: 'HAPPY 24 배너', cost: [{ res: 'wood', amount: 600 }, { res: 'metal', amount: 300 }, { res: 'gem', amount: 250 }, { res: 'flower', amount: 800 }], craftTime: 40, workshop: 'woodshop', day: 5 },
    { id: 23, name: '플라스틱 부품', cost: [{ res: 'gem', amount: 500 }, { res: 'metal', amount: 250 }, { res: 'wood', amount: 800 }, { res: 'stone', amount: 1200 }], craftTime: 45, workshop: 'jewelshop', day: 5 },
    { id: 24, name: '리본', cost: [{ res: 'flower', amount: 2000 }, { res: 'metal', amount: 350 }, { res: 'gem', amount: 350 }, { res: 'wood', amount: 600 }, { res: 'stone', amount: 1000 }], craftTime: 60, workshop: 'jewelshop', day: 5 },
];
