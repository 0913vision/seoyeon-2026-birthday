...
export const PARTS: PartDef[] = [
    ...
    { id: 16, name: '보석 장식', cost: [{ res: 'gem', amount: 250 }, { res: 'metal', amount: 200 }, { res: 'wood', amount: 800 }, { res: 'stone', amount: 600 }], craftTime: 30, workshop: 'jewelshop', day: 4 },
    ...
    { id: 21, name: '반도체', cost: [{ res: 'metal', amount: 400 }, { res: 'gem', amount: 250 }, { res: 'stone', amount: 700 }, { res: 'wood', amount: 500 }], craftTime: 50, workshop: 'jewelshop', day: 5 },
    ...
    { id: 23, name: '플라스틱 부품', cost: [{ res: 'gem', amount: 500 }, { res: 'metal', amount: 250 }, { res: 'wood', amount: 800 }, { res: 'stone', amount: 600 }], craftTime: 45, workshop: 'jewelshop', day: 5 },
    { id: 24, name: '리본', cost: [{ res: 'flower', amount: 900 }, { res: 'metal', amount: 350 }, { res: 'gem', amount: 350 }, { res: 'wood', amount: 600 }, { res: 'stone', amount: 500 }], craftTime: 60, workshop: 'jewelshop', day: 5 },
];
